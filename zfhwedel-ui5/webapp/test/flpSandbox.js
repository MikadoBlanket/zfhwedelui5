		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Demo Project",
									"targetURL": "#zfhwedelzfhwedelui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfhwedelzfhwedelui5-display": {
								"semanticObject": "zfhwedelzfhwedelui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfhwedel.zfhwedelui5",
									"url": sap.ui.require.toUrl("zfhwedel/zfhwedelui5")
								}
							}
						}
					}
